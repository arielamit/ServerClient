...
public:
    ...
    virtual ~Event();
     std::string &get_team_a_name() ;
     std::string &get_team_b_name() ;
     std::string &get_name() ;
    int get_time() ;
     std::map<std::string, std::string> &get_game_updates() ;
     std::map<std::string, std::string> &get_team_a_updates() ;
     std::map<std::string, std::string> &get_team_b_updates() ;
